...
#[component]
pub fn StaticCard(children: Element, #[props(default)] class: String) -> Element {
  rsx! {
    div {
      class: "card {class}",
      {children}
...
pub fn CardContent(
  ...
  let padding_class = if padding.is_empty() {
    "p-4"
  } else {
    padding.as_str()
  };
...
/// Card footer section
#[component]
pub fn CardFooter(children: Element, #[props(default)] class: String) -> Element {
  rsx! {
    div {
