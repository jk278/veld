...
/// Modal content area
#[component]
pub fn ModalContent(children: Element, #[props(default)] class: String) -> Element {
  rsx! {
    div {
...
#[component]
pub fn ModalFooter(children: Element, #[props(default)] class: String) -> Element {
  rsx! {
    div {
...
#[component]
pub fn AdvancedSection(children: Element) -> Element {
  rsx! {
    div {
